(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("react-color-scroll", [], factory);
	else if(typeof exports === 'object')
		exports["react-color-scroll"] = factory();
	else
		root["react-color-scroll"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ColorScroll = function (_PureComponent) {
	  _inherits(ColorScroll, _PureComponent);
	
	  function ColorScroll(props) {
	    _classCallCheck(this, ColorScroll);
	
	    var _this = _possibleConstructorReturn(this, (ColorScroll.__proto__ || Object.getPrototypeOf(ColorScroll)).call(this, props));
	
	    _this.state = {
	      spaces: false,
	      background: _this.props.colors[0]
	    };
	
	    _this.scrollContainer = null;
	    _this.onScroll = _this.onScroll.bind(_this);
	    _this.calculateSpaces = _this.calculateSpaces.bind(_this);
	    _this.blendColors = _this.blendColors.bind(_this);
	    return _this;
	  }
	
	  _createClass(ColorScroll, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      var spaces = this.calculateSpaces();
	      if (!spaces) {
	    ...
	    key: 'blendColors',
	    value: function blendColors(color1, color2, percentage) {
	    ...
	    key: 'calculateSpaces',
	    value: function calculateSpaces() {
	      var scrollHeight = this.scrollContainer.scrollHeight;
	      var amountOfColors = this.props.colors ? this.props.colors.length : 0;
	      if (amountOfColors > 0) {
	        var percentage = 100 / amountOfColors;
	        var spaces = scrollHeight * (percentage / 100);
	        return spaces;
	      }
	    ...
	    value: function onScroll(e) {
	      if (this.state.spaces) {
	        ...
	        var index = Math.floor(scrollPos / this.state.spaces);
	        var percentage = Math.round((scrollPos - this.state.spaces * index) / this.state.spaces * 100) / 100;
	
	        if (this.props.colors[index + 1]) {
	          var background = this.blendColors(this.props.colors[index], this.props.colors[index + 1], percentage);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        {
	          ...
	          ref: function ref(el) {
	            return _this2.scrollContainer = el;
	          },
	        ...
	        _react.Children.toArray(this.props.children)
	      );
	    }
	  }]);
...
;
//# sourceMappingURL=react-color-scroll.min.js.map